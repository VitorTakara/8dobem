...
export class FakeDetailComponent implements OnInit {
  ...
  shareGuide(type){
    if(type === "facebook"){
      ...
      window.open(`https://wa.me/?text=Olha só que matéria legal que eu vi no portal do Guia COVID-19 sobre ${this.guide.title}: https://www.guiacovid19.com.br/%23/fakenews/`)
    }
  }
